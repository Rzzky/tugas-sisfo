        ...
        <form action="{{ route('barang.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="kode_barang" id="kode_barang" value="{{ old('kode_barang') }}" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>

                <div>
                    <label for="nama_barang" class="block text-sm font-medium text-gray-700 mb-1">Nama Barang <span class="text-red-500">*</span></label>
                    <input type="text" name="nama_barang" id="nama_barang" value="{{ old('nama_barang') }}" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="jumlah" id="jumlah" value="{{ old('jumlah', 0) }}" min="0" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>

                <div>
                    <label for="tersedia" class="block text-sm font-medium text-gray-700 mb-1">Tersedia <span class="text-red-500">*</span></label>
                    <input type="number" name="tersedia" id="tersedia" value="{{ old('tersedia', 0) }}" min="0" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>

                <div>
                    <label for="dipinjam" class="block text-sm font-medium text-gray-700 mb-1">Dipinjam <span class="text-red-500">*</span></label>
                    <input type="number" name="dipinjam" id="dipinjam" value="{{ old('dipinjam', 0) }}" min="0" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>

                <div>
                    <label for="lokasi" class="block text-sm font-medium text-gray-700 mb-1">Lokasi <span class="text-red-500">*</span></label>
                    <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi') }}" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>
            ...
            <div>
                ...
                <textarea name="keterangan" id="keterangan" rows="3" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('keterangan') }}</textarea>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        jumlahInput.addEventListener('change', function() {
            tersediaInput.value = jumlahInput.value;
