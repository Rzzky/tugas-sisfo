...
<head>
    ...
    <title>Laporan Pengembalian Bulanan</title>
    <style>
        body {
...
<body onload="window.print()">
    <div class="header">
        ...
        <p class="subtitle">LAPORAN PENGEMBALIAN BULANAN</p>
        ...
        <tbody>
            @forelse($data as $index => $item)
                <tr>
                    ...
                    <td>
                        @if($item->label_status == 'tepat_waktu')
                            <span class="badge badge-success">Tepat Waktu</span>
                        @elseif($item->label_status == 'terlambat')
                            <span class="badge badge-danger">Terlambat</span>
                        @elseif($item->label_status == 'rusak')
                            <span class="badge badge-warning">Rusak</span>
                        @elseif($item->label_status == 'hilang')
